...
func (_Balancervault *BalancervaultCaller) QueryBatchSwap(opts *bind.CallOpts, kind uint8, swaps []IVaultBatchSwapStep, assets []common.Address, funds IVaultFundManagement) ([]*big.Int, error) {
	var out []interface{}
	err := _Balancervault.contract.Call(opts, &out, "queryBatchSwap", kind, swaps, assets, funds)
...
//
// Solidity: function queryBatchSwap(uint8 kind, (bytes32,uint256,uint256,uint256,bytes)[] swaps, address[] assets, (address,bool,address,bool) funds) view returns(int256[])
func (_Balancervault *BalancervaultSession) QueryBatchSwap(kind uint8, swaps []IVaultBatchSwapStep, assets []common.Address, funds IVaultFundManagement) ([]*big.Int, error) {
	return _Balancervault.Contract.QueryBatchSwap(&_Balancervault.CallOpts, kind, swaps, assets, funds)
}

// QueryBatchSwap is a free data retrieval call binding the contract method 0xf84d066e.
//
// Solidity: function queryBatchSwap(uint8 kind, (bytes32,uint256,uint256,uint256,bytes)[] swaps, address[] assets, (address,bool,address,bool) funds) view returns(int256[])
func (_Balancervault *BalancervaultCallerSession) QueryBatchSwap(kind uint8, swaps []IVaultBatchSwapStep, assets []common.Address, funds IVaultFundManagement) ([]*big.Int, error) {
	return _Balancervault.Contract.QueryBatchSwap(&_Balancervault.CallOpts, kind, swaps, assets, funds)
}
