...
func (x *GetTokenPriceRequest) GetAddress() []byte {
	if x != nil {
		return x.Address
	}
	return nil
...
func (x *GetTokenPriceResponse) GetPrice() []byte {
	if x != nil {
		return x.Price
	}
	return nil
...
var file_price_proto_rawDesc = []byte{
	...
	0x14, 0x0a, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05,
